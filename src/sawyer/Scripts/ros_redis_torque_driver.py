...
class TorqueDriver(object):
    def __init__(self, limb="right"):
        ...
        self._redis.set('cs225a::sawyer::actuators::fgc', '0 0 0 0 0 0 0')
    ...
    def _update_forces(self):
        ...
        redis_forces = self._redis.get('cs225a::sawyer::actuators::fgc')
        ...
        self._redis.set('cs225a::sawyer::sensors::q', q_str_redis)
        self._redis.set('cs225a::sawyer::sensors::dq', dq_str_redis)

        # Set timestamp
        rt = rospy.Time.from_sec(time.time()) - self._start_time
        self._redis.set('cs225a::sawyer::timestamp', str(rt.to_sec()))
